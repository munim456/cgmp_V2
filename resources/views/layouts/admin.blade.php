            ...
            <nav class="mt-4 flex flex-col gap-1 px-4 text-sm">
                @php
                    $links = [
                        ...
                        ['admin.announcements.index', 'Announcements', 'm3 11 18-5v12L3 14v-3zM11 6v12M6 14v4a1 1 0 0 0 1 1h2'],
                        ['admin.testimonials.index', 'Testimonials', 'M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 21 12 17.77 5.82 21 7 14.14l-5-4.87 6.91-1.01z'],
