    ...
    <div class="safe-area-top bg-[#1B72B5] text-xs text-white sm:text-sm">
        <div class="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-2 sm:px-6">
            <span class="flex items-center gap-2 sm:gap-5">
                <a href="tel:{{ preg_replace('/\s+/', '', setting('phone', '')) }}" class="flex items-center gap-1.5 hover:underline">
            ...
            <span class="flex items-center gap-4">
                ...
                <x-healthengine-button label="Book Online" class="rounded-full bg-brand-green px-3 py-1 text-xs font-semibold text-white transition-colors hover:bg-brand-green-dark" />
            </span>
        </div>
    </div>
