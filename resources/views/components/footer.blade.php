    ...
    <div class="mx-auto grid max-w-6xl gap-12 md:grid-cols-4">
        <div>
            ...
            @if(setting('facebook_url'))
                <a href="{{ setting('facebook_url') }}" target="_blank" rel="noopener" class="mt-7 flex h-11 w-11 items-center justify-center rounded-lg bg-white/10 font-bold">f</a>
            @endif
        </div>
...
<button
    ...
    class="fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-brand-blue text-white shadow-xl hover:bg-brand-blue-dark transition-colors"
>
