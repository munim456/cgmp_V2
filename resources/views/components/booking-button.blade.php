...
<a href="{{ route('booking') }}" {{ $attributes->merge(['class' => "btn-lift inline-flex items-center gap-3 rounded-2xl bg-brand-green {$padding} font-bold text-white shadow-lg hover:bg-brand-green-dark"]) }}>
