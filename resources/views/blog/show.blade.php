...
<section class="px-6 py-24">
    <article class="mx-auto max-w-3xl" data-reveal>
        ...
        <div class="mt-10 flex items-center gap-3 border-t border-slate-100 pt-8" x-data="{
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" rel="noopener" aria-label="Share on Facebook" class="flex h-10 w-10 items-center justify-center rounded-full bg-brand-blue-tint text-brand-blue hover:bg-brand-blue hover:text-white hover:scale-110 transition-all">
            ...
            <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($post->title) }}" target="_blank" rel="noopener" aria-label="Share on X" class="flex h-10 w-10 items-center justify-center rounded-full bg-brand-blue-tint text-brand-blue hover:bg-brand-blue hover:text-white hover:scale-110 transition-all">
            ...
            <a href="mailto:?subject={{ urlencode($post->title) }}&body={{ urlencode(url()->current()) }}" aria-label="Share via email" class="flex h-10 w-10 items-center justify-center rounded-full bg-brand-blue-tint text-brand-blue hover:bg-brand-blue hover:text-white hover:scale-110 transition-all">
            ...
            <button type="button" @click="copyLink" aria-label="Copy link" class="flex h-10 w-10 items-center justify-center rounded-full bg-brand-blue-tint text-brand-blue hover:bg-brand-blue hover:text-white hover:scale-110 transition-all">
